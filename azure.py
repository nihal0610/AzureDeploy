...
#if button0 is True:
llm = AzureChatOpenAI(
    azure_deployment="gpt-35-turbo-16k",  # your model deployment name on Azure OpenAI
    azure_endpoint="https://openaigsk1.openai.azure.com/",  # Azure endpoint
    openai_api_version="2024-05-01-preview",  # Azure-specific API version
    openai_api_key=api_key,  # Use environment variables to store this securely
